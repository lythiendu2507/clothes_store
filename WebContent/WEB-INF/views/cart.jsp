                        ...
                        <tr>
                            ...
                            <td>
                                <a href="" title="" class="thumb">
                                    <img src="public/images/${u.anh }" alt="">
                                </a>
                            </td>
                            <td>
                                ${u.ten }
                            ...
                            <td>
                                <a href="${u.id_cart}.htm" title="" class="del-product"><i class="fa fa-trash-o"></i></a>
                            </td>                          
                        </tr>
                        </c:forEach>
                    </tbody>
                            ...
                            <td colspan="8">
                                <div class="clearfix">
                                    <div class="fl-right">
                                        ...
                                        <a href="check_out.htm" title="" id="checkout-cart">Thanh toán</a>                                        
                                    </div>
                                </div>
                            </td>
                        </tr>
