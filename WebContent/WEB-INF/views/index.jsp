				...
				<div id="head-top" class="clearfix">
					<div class="wp-inner">
						...
						<div id="main-menu-wp" class="fl-right">
							...
							<c:forEach var="u" items="${List_page }">
								<li><a href="index.htm" title="">${u.list_page }</a></li>
							</c:forEach>
							</ul>
						</div>
					</div>
				...
				<div class="wp-inner">
							...
							<div class="section-detail">
								...
								<ul class="list-item">
									<c:forEach var="u" items="${hot_product }">
										<c:url var="Clothes_Store" value="/product.htm">
										...
										<li class="fbbox">
										<a
											href="http://localhost:9999/<c:out value="${Clothes_Store}"/>"
											title="" class="thumb"> 
									...
									<c:forEach var="u" items="${product}">
										...
										<li class="fbbox"><a
											...
											<ul class="product-name, x">
												<li><a
													href="http://localhost:9999/<c:out value="${Clothes_Store}"/>"><img
					...
					<div class="sidebar fl-left">
						<div class="section" id="category-product-wp">
							...
							<div class="secion-detail">
								<ul class="list-item">
									<li><a href="?page=category_product" title="">Theo chủ
											đề</a>
										<ul class="sub-menu">
									...
									<li><a href="?page=category_product" title="">Áo Khoắc</a></li>
									<li><a href="?page=category_product" title="">Phụ kiện</a></li>
								</ul>
							</div>
						</div>
						<div class="section" id="selling-wp">
							<div class="section-head">
								<h3 class="section-title">Trang phục đang khuyến mãi</h3>
							</div>
							<div class="section-detail">
								<ul class="list-item">
						...
						<div class="section" id="banner-wp">
							<div class="section-detail">								
								<iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FMinh9001%2F&tabs=timeline&width=280&height=700&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" 
									width="280" height="700" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true" allow="encrypted-media"></iframe>
							</div>
						</div>
					</div>
				</div>
